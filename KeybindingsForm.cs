...
namespace EyeTracker
{
    public partial class KeybindingsForm : Form
    {
        ...
        public KeybindingsForm(Form1 form, List<Command> commands)
        {
            ...
            button1.Text = commands[3].Name;
            button2.Text = commands[4].Name;
            button3.Text = commands[5].Name;
            button4.Text = commands[6].Name;
            button5.Text = commands[7].Name;
            button6.Text = commands[8].Name;
            button7.Text = commands[9].Name;
        }
